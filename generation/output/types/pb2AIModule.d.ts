...
declare global {
    interface pb2AIModule extends ClassIdentityProps<"pb2AIModule"> {
        ...
        readonly allow_trace_shots: TODO;
        readonly allow_hit_reporting: TODO;
         ...
         */
        GoTo: (x: TODO, y: TODO, mode?: TODO) => TODO;
        hunt_attacker: TODO;
        hunt_seen_threats: TODO;
        hunt_random_known_threats_range: TODO;
        heal_teammates: TODO;
        hear_range: TODO;
    }
